...
import 'package:lottery_kr/page/generator/CameroonLottoNumberGenerator.dart';
...
import 'package:lottery_kr/page/generator/SADailyLottoNumberGenerator.dart';
import 'package:lottery_kr/page/generator/SALottoNumberGenerator.dart';
import 'package:lottery_kr/page/generator/SALottoPlus1NumberGenerator.dart';
import 'package:lottery_kr/page/generator/SALottoPlus2NumberGenerator.dart';
import 'package:lottery_kr/page/generator/SAPowerballNumberGenerator.dart';
...
class NumberGenerateService {
    ...
    switch (lotteryDetails["dbTitle"]) {
      ...
      case "saLotto":
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => SALottoNumberGenerator(
              lotteryDetails: lotteryDetails, 
              lotteryData: lotteryData,
            ),
          ),
      ...
      case "saLottoPlus1":
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => SALottoPlus1NumberGenerator(
              lotteryDetails: lotteryDetails, 
              lotteryData: lotteryData,
            ),
          ),
      ...
      case "saLottoPlus2":
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => SALottoPlus2NumberGenerator(
              lotteryDetails: lotteryDetails, 
              lotteryData: lotteryData,
            ),
          ),
      ...
      case "saPowerball":
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => SAPowerballNumberGenerator(
              lotteryDetails: lotteryDetails, 
              lotteryData: lotteryData,
            ),
          ),
      ...
      case "saDailyLotto":
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => SADailyLottoNumberGenerator(
              lotteryDetails: lotteryDetails, 
              lotteryData: lotteryData,
            ),
          ),
      ...
      case "cameroon5-90":
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => CameroonLottoNumberGenerator(
              lotteryDetails: lotteryDetails, 
              lotteryData: lotteryData,
            ),
          ),
  ...
  Future<Map<String, List<int>>?> generateNumberByLottoName(String lottoName, int generatedNumbersCnt, BuildContext context) async {
    ...
    if (generatedNumbersCnt < capacity) {
      switch(lottoName) {
        ...
        case "SA Lotto":
          return generateSALottoNumber();
        case "Lotto Plus 1":
          return generateSALottoPlus1Number();
        case "Lotto Plus 2":
          return generateSALottoPlus2Number();
        case "SA Powerball":
          return generateSAPowerballNumber();
        case "Daily Lotto":
          return generateSADailyLottoNumber();
        case "Loto 5/90":
          return generateLoto590Number();
        default:
          return null;
      }
    } else {
  ...
  Map<String, List<int>>? generateSALottoNumber() {
    Map<String, List<int>> numbersMap;
    List<int> _lottoNumbers = [];
    Random random = Random();
    while (_lottoNumbers.length < 5) {
      int nextNumber = random.nextInt(52) + 1;
      if (!_lottoNumbers.contains(nextNumber)) {
        _lottoNumbers.add(nextNumber);
      }
    }
    _lottoNumbers.sort();
    int bonus = random.nextInt(52) + 1;
    numbersMap = {'numbers': _lottoNumbers, 'bonus': [bonus], 'reintegro': []};
    return numbersMap;
  }

  Map<String, List<int>>? generateSALottoPlus1Number() {
    Map<String, List<int>> numbersMap;
    List<int> _lottoNumbers = [];
    Random random = Random();
    while (_lottoNumbers.length < 5) {
  ...
  Map<String, List<int>>? generateSALottoPlus2Number() {
    Map<String, List<int>> numbersMap;
    List<int> _lottoNumbers = [];
    Random random = Random();
    while (_lottoNumbers.length < 5) {
  ...
  Map<String, List<int>>? generateSAPowerballNumber() {
    Map<String, List<int>> numbersMap;
    List<int> _lottoNumbers = [];
    Random random = Random();
    while (_lottoNumbers.length < 5) {
    ...
    _lottoNumbers.sort();
    int bonus = random.nextInt(20) + 1;
    numbersMap = {'numbers': _lottoNumbers, 'bonus': [bonus], 'reintegro': []};
    return numbersMap;
  }

  Map<String, List<int>>? generateSADailyLottoNumber() {
    Map<String, List<int>> numbersMap;
    List<int> _lottoNumbers = [];
    Random random = Random();
    while (_lottoNumbers.length < 5) {
      int nextNumber = random.nextInt(36) + 1;
      if (!_lottoNumbers.contains(nextNumber)) {
        _lottoNumbers.add(nextNumber);
      }
    }
  ...
  Map<String, List<int>>? generateLoto590Number() {
    Map<String, List<int>> numbersMap;
    List<int> _lottoNumbers = [];
    Random random = Random();
    while (_lottoNumbers.length < 5) {
