...
class EuroMillonGenerator extends StatefulWidget {
  final Map<String, dynamic> lotteryDetails;
  final Map<String, dynamic> lotteryData;
  const EuroMillonGenerator({super.key, required this.lotteryDetails, required this.lotteryData});

  @override
  State<EuroMillonGenerator> createState() => _EuroMillonGeneratorState();
}

class _EuroMillonGeneratorState extends State<EuroMillonGenerator> {
