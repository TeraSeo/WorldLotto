...
class SADailyLottoNumberGenerator extends StatefulWidget {
  final Map<String, dynamic> lotteryDetails;
  final Map<String, dynamic> lotteryData;
  const SADailyLottoNumberGenerator({super.key, required this.lotteryDetails, required this.lotteryData});

  @override
  State<SADailyLottoNumberGenerator> createState() => _SADailyLottoNumberGeneratorState();
}

class _SADailyLottoNumberGeneratorState extends State<SADailyLottoNumberGenerator> {
