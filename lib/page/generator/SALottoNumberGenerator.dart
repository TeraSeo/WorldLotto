...
class SALottoNumberGenerator extends StatefulWidget {
  final Map<String, dynamic> lotteryDetails;
  final Map<String, dynamic> lotteryData;
  const SALottoNumberGenerator({super.key, required this.lotteryDetails, required this.lotteryData});

  @override
  State<SALottoNumberGenerator> createState() => _SALottoNumberGeneratorState();
}

class _SALottoNumberGeneratorState extends State<SALottoNumberGenerator> {
