...
class CameroonLottoNumberGenerator extends StatefulWidget {
  final Map<String, dynamic> lotteryDetails;
  final Map<String, dynamic> lotteryData;
  const CameroonLottoNumberGenerator({super.key, required this.lotteryDetails, required this.lotteryData});

  @override
  State<CameroonLottoNumberGenerator> createState() => _CameroonLottoNumberGeneratorState();
}

class _CameroonLottoNumberGeneratorState extends State<CameroonLottoNumberGenerator> {
        ...
        child: isNumbersLoading ? const Center(child: CircularProgressIndicator(color: Colors.white)) : Column(
          children: [
            ...
            Container(
              ...
              child: NumberofPlays(length: numbers.length, lotteryDetails: widget.lotteryDetails, isUnkown: true),
            ),
            Expanded(
