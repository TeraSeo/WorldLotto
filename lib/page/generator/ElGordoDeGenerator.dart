...
class ElGordoDeGenerator extends StatefulWidget {
  final Map<String, dynamic> lotteryDetails;
  final Map<String, dynamic> lotteryData;
  const ElGordoDeGenerator({super.key, required this.lotteryDetails, required this.lotteryData});

  @override
  State<ElGordoDeGenerator> createState() => _ElGordoDeGeneratorState();
}

class _ElGordoDeGeneratorState extends State<ElGordoDeGenerator> {
