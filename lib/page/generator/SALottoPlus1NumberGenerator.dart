...
class SALottoPlus1NumberGenerator extends StatefulWidget {
  final Map<String, dynamic> lotteryDetails;
  final Map<String, dynamic> lotteryData;
  const SALottoPlus1NumberGenerator({super.key, required this.lotteryDetails, required this.lotteryData});

  @override
  State<SALottoPlus1NumberGenerator> createState() => _SALottoPlus1NumberGeneratorState();
}

class _SALottoPlus1NumberGeneratorState extends State<SALottoPlus1NumberGenerator> {
        ...
        child: isNumbersLoading ? const Center(child: CircularProgressIndicator(color: Colors.white)) : Column(
          children: [
            ...
            Container(
              ...
              child: NumberofPlays(length: numbers.length, lotteryDetails: widget.lotteryDetails, isUnkown: false),
            ),
            Expanded(
