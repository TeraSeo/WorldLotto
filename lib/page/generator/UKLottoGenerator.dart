...
class UKLottoGenerator extends StatefulWidget {
  final Map<String, dynamic> lotteryDetails;
  final Map<String, dynamic> lotteryData;
  const UKLottoGenerator({super.key, required this.lotteryDetails, required this.lotteryData});

  @override
  State<UKLottoGenerator> createState() => _UKLottoGeneratorState();
}

class _UKLottoGeneratorState extends State<UKLottoGenerator> {
