...
class SAPowerballNumberGenerator extends StatefulWidget {
  final Map<String, dynamic> lotteryDetails;
  final Map<String, dynamic> lotteryData;
  const SAPowerballNumberGenerator({super.key, required this.lotteryDetails, required this.lotteryData});

  @override
  State<SAPowerballNumberGenerator> createState() => _SAPowerballNumberGeneratorState();
}

class _SAPowerballNumberGeneratorState extends State<SAPowerballNumberGenerator> {
