...
class SALottoPlus2NumberGenerator extends StatefulWidget {
  final Map<String, dynamic> lotteryDetails;
  final Map<String, dynamic> lotteryData;
  const SALottoPlus2NumberGenerator({super.key, required this.lotteryDetails, required this.lotteryData});

  @override
  State<SALottoPlus2NumberGenerator> createState() => _SALottoPlus2NumberGeneratorState();
}

class _SALottoPlus2NumberGeneratorState extends State<SALottoPlus2NumberGenerator> {
