...
class LotteryCardDetails {
  ...
  List<Map<String, dynamic>> southAfricanLotteries = [
    {
      "lottoName": "SA Lotto",
      "dbTitle": "saLotto",
    ...
    },
    {
      ...
      "backgroundColor": const Color.fromARGB(255, 241, 105, 105),
      "dialogTopColor": Colors.lightBlue,
      "dialogButtonColor": const Color.fromARGB(255, 241, 105, 105),
      "normalNumberCount": 5,
      "bonusNumberCount": 1,
      "bonusNumberText": "selectBonus".tr(),
  ...
  List<Map<String, dynamic>> cameroonLotteries = [
    {
      "lottoName": "Loto 5/90",
