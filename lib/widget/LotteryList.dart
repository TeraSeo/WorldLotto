...
class _LotteryListState extends State<LotteryList> {
  ...
  void addLotteryDatasByCountry(String country) {
    ...
    setState(() {
      ...
      else if (widget.selectedTab == "Japan") {
        lotteryList.add(lotteryCardDetails.japanLotteries);
      }
      else if (widget.selectedTab == "South Africa") {
        lotteryList.add(lotteryCardDetails.southAfricanLotteries);
      }
      else if (widget.selectedTab == "Cameroon") {
        lotteryList.add(lotteryCardDetails.cameroonLotteries);
      }
    });
  }
