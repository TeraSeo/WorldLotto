...
class NumberofPlays extends StatefulWidget {
  ...
  final bool isUnkown;
  const NumberofPlays({super.key, required this.length, required this.lotteryDetails, required this.isUnkown});
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        ...
        SizedBox(width: 10),
        widget.isUnkown ?
        Flexible(child: Text("playCost".tr() + ": Whatever", style: TextStyle(fontSize: screenHeight * 0.015, decoration: TextDecoration.none, color: Colors.black, fontWeight: FontWeight.w700), overflow: TextOverflow.ellipsis)) :
